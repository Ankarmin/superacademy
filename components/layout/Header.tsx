...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/20 bg-white/85 shadow-[0_4px_30px_rgba(0,0,0,0.06)] backdrop-blur-xl">
      <nav className="container mx-auto flex h-[84px] items-center justify-between px-6 lg:h-[88px] lg:px-8">
        <Link
          href="/"
        ...
        <ul className="hidden items-center gap-9 md:flex lg:gap-10">
          {publicNavigationLinks.map((link) => {
            ...
            return (
              <li key={link.href}>
                <Link href={link.href} className="group relative font-bold">
                  <span
          ...
          <li>
            <button
              ...
              className="group relative inline-flex cursor-pointer items-center justify-center overflow-hidden rounded-2xl border-2 border-[#028aa7] bg-gradient-to-r from-[#01b8db] via-[#59e7ff] to-[#01b8db] px-7 py-3.5 font-extrabold tracking-[0.14em] text-slate-950 shadow-[0_18px_40px_rgba(1,184,219,0.38)] ring-4 ring-[#01b8db]/15 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_24px_54px_rgba(1,184,219,0.48)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#01b8db]/30"
            >
